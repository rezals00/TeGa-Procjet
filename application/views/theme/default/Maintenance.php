...
<head>
	...
	<link href="<?=base_url();?>/cdn/css/style.css" rel="stylesheet" type="text/css" media="all" />
	...
	<div class="content">
			...
			<p><img src="<?=base_url();?>cdn/images/top.png" title=""></p>
				</div>
				<div class="grid">
		<p><img src="<?=base_url();?>cdn/images/coming.png" title=""></p>
		...
		<div class="clear"></div>
		<div class="footer">
			<p class="a"><a href="#"><img src="<?=base_url();?>cdn/images/facebook.png" title=""></a><a href="#"><img src="<?=base_url();?>cdn/images/twitter.png" title=""></a></p>
